...
$nombre_producto = isset($_POST['nombre_producto']) ? $connec->real_escape_string($_POST['nombre_producto']) : '';
...
$sql = "UPDATE tb_productos_06 SET nombre_producto = '$nombre_producto', precio_producto = '$precio_producto' WHERE id_producto = '$id_producto'";
